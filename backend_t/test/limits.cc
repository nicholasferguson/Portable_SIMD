...
int main(int argc, char *argv[])
{
  ...
  Test<backend::UMESimd>("UMESimd");
  Test<backend::UMESimdArray<2>>("UMESimdArray<2>");
  Test<backend::UMESimdArray<4>>("UMESimdArray<4>");
  Test<backend::UMESimdArray<8>>("UMESimdArray<8>");
  Test<backend::UMESimdArray<16>>("UMESimdArray<16>");
  Test<backend::UMESimdArray<32>>("UMESimdArray<32>");
#endif
